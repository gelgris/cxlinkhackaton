...
variable "cl_ir_comprehend_kms_key_alias_name" {
  type = string
  description = "CxLink Ireland Landing Zone comprehend Buckets Encryption Custom KMS Key Alias Name"
}

variable "cl_ir_comprehend_kms_key_description" {
  type = string
  description = "CxLink Ireland Landing Zone comprehend Buckets Encryption Custom KMS Key Description"
}

variable "cl_ir_comprehend_kms_key_retention" {
  type = number
  description = "CxLink Ireland Landing Zone comprehend Buckets Encryption Custom KMS Key Retention before Deletion (in days)"
}
