...
resource "aws_amplify_backend_environment" "cl_ir_ml_hackathon_app_master_backend" {
  ...
  deployment_artifacts = var.cl_ir_ml_hackathon_app_master_artifacts
  stack_name           = var.cl_ir_ml_hackathon_app_prod_frontend_bucket_name
}
...
resource "aws_amplify_backend_environment" "cl_ir_ml_hackathon_app_development_backend" {
  ...
  deployment_artifacts = var.cl_ir_ml_hackathon_app_development_artifacts
  stack_name           = var.cl_ir_ml_hackathon_app_dev_frontend_bucket_name
}
